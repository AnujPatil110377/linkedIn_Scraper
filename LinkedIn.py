...
def main():
    ...
    wb = load_workbook("C:/Users/91798/LinkedIn/company.xlsx")
    sheet = wb.active
    ...
    sheet_new.append(["Company", "Name", "Position", "LinkedIn URL"])
    ...
    for company in companies:
        for keyword in job_keywords:
            ...
            for name, position, linkedin_url in data:
                sheet_new.append([company, name, position, linkedin_url])
